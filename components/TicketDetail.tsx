        ...
        <div className="flex-1 border-r border-solid border-[#D3D3D3] pr-4">
          ...
          <section className="">
            <div className="flex items-center gap-2 pb-2 mb-3 py-4 border-solid border-b border-[#D3D3D3]">
              <IconEBook size={0} />
              <span className="font-medium text-gray-700 text-base">Description</span>
            </div>
            ...
            <a href="#" className="text-sky-700 text-sm mt-2 inline-block font-medium">+ Add sub-tickets</a>
          </section>
          ...
          <section className="mt-10">
            ...
            <ul className="space-y-1 mb-4">
              <li className="flex items-center gap-2 text-sm">
                ...
                <span className="text-gray-700">RFX Phu Nguyen Submitted to underwriting</span>
                <span className="ml-2 text-gray-400 text-xs">2025-04-04 13:00:38</span>
              </li>
              <li className="flex items-center gap-2 text-sm">
                ...
                <span className="ml-2 text-gray-400 text-xs">2025-04-04 11:10:38</span>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <span className="w-3 h-3 rounded-full bg-green-500 inline-block"></span>
                <span className="text-gray-700">RFX Phu Nguyen Submitted to underwriting</span>
                <span className="ml-2 text-gray-400 text-xs">2025-04-04 08:00:00</span>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <span className="w-3 h-3 rounded-full bg-blue-700 inline-block"></span>
                <span className="text-gray-700">ABC Trang Nguyen create an issue</span>
                <span className="ml-2 text-gray-400 text-xs">2025-04-03 17:10:38</span>
              </li>
            </ul>
        ...
        <div className="w-80 bg-white border border-gray-200 rounded h-fit min-w-[260px]">
          ...
          <div className="space-y-3 text-sm py-2 px-4">
            <div className="flex justify-between">
              ...
              <span className="text-sky-700 font-medium cursor-pointer">In-Progress</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Priority:</span>
              <span className="text-red-600 font-medium cursor-pointer">Critical</span>
            </div>
            <div className="flex justify-between">
